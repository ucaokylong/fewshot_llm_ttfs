#!/bin/bash
#SBATCH -p GPU-1
#SBATCH -J XGB_Diabetes_Top5_10_Inference
#SBATCH -n 1
#SBATCH -c 8
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
#SBATCH --time=72:00:00
#SBATCH -o XGB_Inference_Top5_10_Output-%j.log
...
# ==========================================
echo "=========================================================="
echo "[RUNNING] XGBoost Granular Evaluation..."
echo "=========================================================="
...
python -u xgboost_fewshot_top5_10.py
