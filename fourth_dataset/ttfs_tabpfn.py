...
# Explicit paths aligned with the new Cardiovascular data pipeline
CANDIDATE_POOL_PATH = "cardio_candidate_balanced.csv"
TEST_SET_PATH = "cardio_test_fixed.csv"
INDEX_FILE_PATH = "master_granular_indices_cardio.json"
TARGET = "cardio"
...
# Baseline feature subsets mapped to the Cardiovascular Disease schema (Top 5 & Top 10)
TOP_5_BASE_FEATURES = [
        "ap_hi", "age", "weight", "height", "ap_lo"
    ]
TOP_10_BASE_FEATURES = [
        "ap_hi", "age", "weight", "height", "ap_lo", 
        "cholesterol", "gender", "active", "gluc", "smoke"
    ]
...
if __name__ == "__main__":
    ...
    for config_name, starting_features in CONFIGURATIONS_TO_RUN.items():
        output_directory = f"cardio_ttfs_tabpfn_{config_name}"
        ...
        for current_k in FEW_SHOT_K_VALUES:
            results_csv_path = os.path.join(output_directory, f'cardio_dynamic_results_k{current_k}.csv')
