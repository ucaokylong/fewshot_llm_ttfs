...
class ExperimentConfig:
    # Path mappings for the pre-balanced Cardiovascular Disease files
...
TEMP_DIR = f"cardio_xai_temp_k{ExperimentConfig.K_TARGET}"
...
# ==========================================
output_csv = f"cardio_xai_global_ranking_k{ExperimentConfig.K_TARGET}.csv"
output_json = f"cardio_xai_selected_features_k{ExperimentConfig.K_TARGET}.json"
