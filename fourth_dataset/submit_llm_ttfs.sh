#!/bin/bash
#SBATCH -p GPU-1A
#SBATCH -J Qwen_cardio_TTFS_Inference
#SBATCH -n 1
#SBATCH -c 8
#SBATCH --gres=gpu:1
#SBATCH --mem=128G
#SBATCH --time=72:00:00
#SBATCH -o Qwen_Inference_TTFS_Output-%j.log
