...
class ExperimentConfig:
    ...
    # Path mappings for the Cardiovascular Disease files
    ...
    # EXACT Feature subsets derived directly from your KernelSHAP JSON output
    TOP_5_FEATURES = [
...
def run_experiment():
    ...
    for config_name, feature_list in ExperimentConfig.FEATURE_SETS.items():
        ...
        print(f"Active Features: {feature_list}")
        print(f"{'='*60}")
        
        output_dir = f"cardio_llm_baselines_{config_name}"
