...
def generate_master_indices(candidate_file="framingham_candidate_balanced.csv"):
    ...
    # Corrected syntax: Using default_rng instead of default_random_state
    ...
    output_json_path = "master_granular_indices_framingham.json"
