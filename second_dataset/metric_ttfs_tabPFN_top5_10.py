...
TARGET_FOLDERS = {
    "top5": "framingham_ttfs_tabpfn_top5",
    "top10": "framingham_ttfs_tabpfn_top10"
}
...
if __name__ == "__main__":
    ...
    for config_label, folder_name in TARGET_FOLDERS.items():
        summary_results = []
        output_summary_csv = f"framingham_ttfs_tabpfn_{config_label}_metrics_summary.csv"
        ...
        for k in K_VALUES:
            file_path = os.path.join(folder_name, f'framingham_dynamic_results_k{k}.csv')
