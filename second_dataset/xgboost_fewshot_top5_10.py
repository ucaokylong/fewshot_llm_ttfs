...
# ==========================================
# Automatic device acceleration fallback structure
...
class ExperimentConfig:
    ...
    # Feature subsets mapped directly from your TabPFN-KernelSHAP ranking json
...
for config_name, feature_list in ExperimentConfig.FEATURE_SETS.items():
    ...
    output_dir = f"framingham_xgboost_baselines_{config_name}"
    os.makedirs(output_dir, exist_ok=True)

    # Inner loops: Few-shot constraints and iterations
    for k in ExperimentConfig.K_VALUES:
        res_file = os.path.join(output_dir, f'framingham_xgboost_results_granular_k{k}.csv')
        ...
        for i in range(ExperimentConfig.ITERATIONS):
            ...
            # Instantiate model with parameters adapted for few-shot constraints
