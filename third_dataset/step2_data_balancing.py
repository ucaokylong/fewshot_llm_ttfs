...
def execute_data_balancing(file_path="heart_attack_cleaned.csv"):
    ...
    # Set test size to 1,000 total (500 per class) as required for robust testing
    ...
    # Extract exactly 500 samples from each class to construct the invariant Test Set
    ...
    df_test_fixed.to_csv("heart_attack_test_fixed.csv", index=False)
    ...
    df_candidate_balanced.to_csv("heart_attack_candidate_balanced.csv", index=False)
