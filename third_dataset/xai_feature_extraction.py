...
class ExperimentConfig:
    # Path mappings for the pre-balanced Heart Attack files
    ...
    # Categorical features that need explicit conversion to handle text labels safely
...
TEMP_DIR = f"heart_attack_xai_temp_k{ExperimentConfig.K_TARGET}"
...
# Fix object dtype fault for tabular transformers: Enforce categorical column assignments
...
# ==========================================
output_csv = f"heart_attack_xai_global_ranking_k{ExperimentConfig.K_TARGET}.csv"
output_json = f"heart_attack_xai_selected_features_k{ExperimentConfig.K_TARGET}.json"
