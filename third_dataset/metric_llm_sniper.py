...
FOLDERS_CONFIG = {
    "heart_attack_llm_sniper_top5": "heart_attack_qwen_sniper_top5_summary.csv",
    "heart_attack_llm_sniper_top10": "heart_attack_qwen_sniper_top10_summary.csv"
}
...
def calculate_sniper_metrics():
    ...
    for folder_name, summary_output in FOLDERS_CONFIG.items():
        ...
        for k in K_VALUES:
            ...
            file_path = os.path.join(folder_name, f'heart_attack_qwen_sniper_k{k}.csv')
